  ...
  return (
    <ThemeProvider theme={muiTheme}>
      <motion.div
        ...
        className="w-full max-w-5xl mx-auto p-4 erp-font"
      >
            ...
            <div className="flex-1 bg-slate-900 p-8 lg:p-12 flex flex-col justify-between border-l border-slate-800">
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <h3 className="text-white font-semibold text-lg border-l-4 border-yellow-500 pl-3">
                    Booking Summary
                  </h3>
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full py-5 rounded-2xl font-bold text-xs uppercase tracking-widest transition-all shadow-xl flex items-center justify-center gap-3 ${submitted ? "bg-emerald-500 text-white" : "bg-yellow-500 text-black hover:bg-yellow-400"} active:scale-95`}
              >
...
function SummaryRow({ label, value }) {
  return (
    <div className="flex justify-between items-center py-2 border-b border-white/5">
      <span className="text-slate-500 text-[10px] font-semibold uppercase tracking-tight">
        {label}
      </span>
