  ...
  if (fetching)
    return (
      <div className="h-screen flex items-center justify-center font-medium text-slate-400 bg-[#F8FAFC]">
        <Loader2 className="animate-spin mr-2 text-yellow-500" />{" "}
        Synchronizing...
      </div>
    );
        ...
        <header className="mb-10 flex flex-col md:flex-row justify-between items-center bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 italic mt-1.5 text-xs">
                Monitor fleet consumption and daily expenses.
              </p>
            </div>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-100">
                  ...
                  <th className="p-6 text-[11px] font-semibold uppercase text-slate-400 text-center">
                    Liters
                  </th>
              ...
              <tbody className="divide-y divide-slate-50">
                {logs.map((log) => (
                  ...
                  >
                    ...
                    <td className="p-6">
                      <span className="bg-slate-900 text-yellow-400 px-3.5 py-2 rounded-xl text-[10px] font-bold uppercase tracking-wider">
                        {log.vehicleNo}
                      </span>
                    </td>
                    <td className="p-6 text-sm text-slate-700 font-medium italic">
                      {log.driver}
                    </td>
                    <td className="p-6 text-sm text-slate-500 font-medium text-center">
                      {log.liters} L
                    </td>
                    <td className="p-6 text-base font-bold text-slate-900 text-right">
                      {Number(log.totalAmount).toLocaleString(undefined, {
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="bg-white w-full max-w-4xl rounded-[2.5rem] shadow-2xl p-10 relative overflow-y-auto max-h-[95vh] custom-scrollbar animate-in zoom-in-95 duration-300">
              ...
              <p className="text-sm text-slate-500 mb-8 font-medium">
                Log filling station details and amounts.
              </p>
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    placeholder="e.g. Medagampitiya"
                    value={formData.fillingStation}
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        fillingStation: e.target.value,
                      })
                    }
                  />
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <Autocomplete
                    ...
                    renderInput={(params) => (
                      <TextField {...params} placeholder="Select Fuel Type" />
                    )}
                  />
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, meterReading: e.target.value })
                    }
                  />
                </div>
                ...
                <div className="md:col-span-2 flex gap-4 pt-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex-[2] py-4 bg-slate-900 text-yellow-400 rounded-xl font-bold uppercase text-[10px] tracking-widest shadow-xl hover:bg-slate-800 transition-all active:scale-[0.98] disabled:opacity-50"
                  >
