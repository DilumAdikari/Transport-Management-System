...
export default function Management({ refresh }) {
  ...
  const handleAddDriver = async () => {
    ...
    try {
      const payload = {
        ...driverData,
        licenseExpire: driverData.licenseExpire
          ? dayjs(driverData.licenseExpire).format("YYYY-MM-DD")
          : null,
      };
      ...
      // Trigger the parent refresh to update notifications and tours immediately
      if (refresh) refresh();
    } catch (err) {
  ...
  const handleAddVehicle = async () => {
    ...
    try {
      const payload = {
        ...
        licenseValid: vehicleData.licenseValid
          ? dayjs(vehicleData.licenseValid).format("YYYY-MM-DD")
          : null,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            <section className="bg-yellow-400 rounded-[2.5rem] p-8 shadow-xl">
              <div className="flex items-center gap-4 mb-8 text-slate-900">
                <div className="w-12 h-12 bg-slate-900 rounded-2xl flex items-center justify-center text-yellow-400 shadow-xl">
                  <UserPlus size={24} />
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="pt-1">
                  <DatePicker
                    ...
                    onChange={(v) =>
                      setDriverData({ ...driverData, licenseExpire: v })
                    }
                    slotProps={{
                ...
                <button
                  ...
                  className="w-full mt-2 py-4 bg-slate-900 text-yellow-400 rounded-2xl font-black uppercase text-xs tracking-[0.2em] flex items-center justify-center gap-3 active:scale-95 transition-all"
                >
            ...
            <section className="bg-slate-900 rounded-[2.5rem] p-8 shadow-xl">
              <div className="flex items-center gap-4 mb-8 text-yellow-400">
                <div className="w-12 h-12 bg-yellow-400 rounded-2xl flex items-center justify-center text-slate-900 shadow-xl">
                  <Truck size={24} />
                </div>
                <h2 className="text-xl font-black uppercase tracking-tight">
                  Add Fleet Unit
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="dark-row">
                  <CalIcon size={16} />
                  <input
                    placeholder="YOM (Year)"
                    value={vehicleData.yom}
                    onChange={(e) =>
                      setVehicleData({ ...vehicleData, yom: e.target.value })
                    }
                  />
                </div>
                ...
                <div className="col-span-1 md:col-span-2 grid grid-cols-2 gap-4">
                  <DatePicker
                    ...
                    onChange={(v) =>
                      setVehicleData({ ...vehicleData, licenseValid: v })
                    }
                    slotProps={{
                      textField: {
                        fullWidth: true,
                  ...
                  <DatePicker
                    ...
                    onChange={(v) =>
                      setVehicleData({ ...vehicleData, emissionValid: v })
                    }
                    slotProps={{
                      textField: {
                        fullWidth: true,
                ...
                <button
                  ...
                  className="md:col-span-2 mt-2 py-4 bg-yellow-400 text-slate-900 rounded-2xl font-black uppercase text-xs tracking-[0.2em] flex items-center justify-center gap-3 active:scale-95 transition-all"
                >
